...
Воспользуемся утилитой ifconfig. Можно увидеть, что IP-адрес компьютера в сети - 192.168.100.12.
...
Блокировать все входящие запросы с определенного адреса (например, ) можно с помощью команды iptables:
